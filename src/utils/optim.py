...
def build_optim(cfg, parameters=None, learning_rate=0.001, grad_clip=None):
    """build optimizer
    Args:
    ...
    return optim_class(parameters=parameters, learning_rate=learning_rate, grad_clip=grad_clip, **cfg.params)